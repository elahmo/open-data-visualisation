...
d3.csv("../data/steamograph.csv", function(data) {
...
function lines() {
  ...
  x.domain([
    d3.min(symbols, function(d) { console.log(d.values[0].date); return d.values[0].date; }),
    d3.max(symbols, function(d) { console.log(d.values[d.values.length - 1].date); return d.values[d.values.length - 1].date; })
  ]);
